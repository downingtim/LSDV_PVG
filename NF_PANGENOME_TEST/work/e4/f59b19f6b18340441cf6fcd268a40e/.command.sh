...
smoothxg \
    --threads=12 \
    --gfa-in=lumpy_2_skin_2_disease_2_virus_2_2_.fasta.gz.community.5.seqwish.gfa \
    --smoothed-out=lumpy_2_skin_2_disease_2_virus_2_2_.fasta.gz.community.5.smoothxg.gfa \
